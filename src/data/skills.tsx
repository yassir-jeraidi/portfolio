...
export const programmingLanguages = (theme: string | undefined): Skill[] => [
...
export const frontend = (theme: string | undefined): Skill[] => [
    ...
    {
        title: "Shadcn UI",
        icon: <Image src={theme === "dark" ? shadcn_ui_icon_dark : shadcn_ui_icon_light} alt="Shadcn UI" width={50}
                     height={50}/>,
    },
...
export const backend = (theme: string | undefined): Skill[] => [
    {title: "Node.js", icon: <Image src={nodejs_icon} alt="Node.js" width={50} height={50}/>},
    {
        title: "Express.js",
        icon: <Image src={theme === "dark" ? expressjs_icon_dark : expressjs_icon_light} alt="Express.js" width={50}
                     height={50}/>,
    },
...
export const devops = (theme: string | undefined): Skill[] => [
    {title: "Docker", icon: <Image src={docker_icon} alt="Docker" width={50} height={50}/>},
    {
        title: "Vercel",
        icon: <Image src={theme === "dark" ? vercel_dark_icon : vercel_light_icon} alt="Vercel" width={50}
                     height={50}/>,
    },
];

export const software = (theme: string | undefined): Skill[] => [
...
export const chartingLibraries: Skill[] = [
