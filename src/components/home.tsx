  ...
  return (
    ...
    >
      <motion.div className="ls" variants={itemVariants}>
        <div className="p-4 flex flex-col justify-center items-center max-w-7xl mx-auto relative z-10 w-full ">
          <Link href="https://v2.jeraidi.tech" className="mb-4">
            <Button className="bg-transparent border rounded-full bg-clip-text text-transparent bg-linear-to-b from-neutral-400 to-neutral-600 cursor-pointer">
          ...
          <p className="mt-4 font-normal text-base text-center text-neutral-500">
            Full Stack Web Developer with a degree in Computer Science and
            practical experience in creating responsive web/desktop
            ...
            Seeking a position to leverage my skills and contribute to
            innovative projects.
          </p>
